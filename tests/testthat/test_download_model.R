...
test_that("download_model does not size-check a user-supplied model_url", {
    ...
    # The expected-size check applies only to the model we host at the default
    # URL; a user-supplied model may legitimately be any size. Downloading a
    # small local file must therefore complete without the size warning.
